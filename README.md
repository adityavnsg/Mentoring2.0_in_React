...
## Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm) or [nvm-windows]
2. **Clone this repository.** - `git clone`
3. **Make sure you're in the directory you just created.** - `cd`
